...
* **Fecha**: Fecha en la que se recogen los datos en formato "AAAA/MM/DD".   
* **Incremento_Muertos**: Número de muertos registrados.  
* **Muertos**: Suma del número de muertos registrados desde el inicio de la pandemia.  
* **Muertos_millon**: Número de muertos registrados por millón de habitantes.   
* **Incremento_Confirmados**: Numero de nuevos casos confirmados.  
* **Confirmados**: Suma del numero de nuevos casos confirmados desde el inicio de la pandemia.
* **Confirmados_100k_14d**: Numero de nuevos casos confirmados por cada 100.000 habitantes en los últimos 14 días.   
...
*   **Epresas y organizaciones privadas:** Para analizar la evolución de la pandemia y optimizar su toma de decisiones en cuanto a su actividad.
